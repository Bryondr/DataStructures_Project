public class CountListNode
{
    ...
    public CountListNode getPrev() { return prev; }

    public void setPrev(CountListNode prev) { this.prev = prev; }

    @Override
    public String toString() { return "Name: " + name +", count= " + count; }

    public String onlyName() { return "Name: " + name; }
}
