public class BST<T extends Comparable<T>>
{
    ...
    //Traverses tree iterative and finds if given node exists in tree prints how many hops it did
    ...
    private void insert(TreeNode<T> root, TreeNode<T> newNode)
    {
        ...
        {
            System.out.println("There is already a student exists with same ID!");
        }
    }
    //Deletes given node
